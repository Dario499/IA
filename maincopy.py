...
def dopropmt(historia_larga, historia_corta, hechos: list, ejemplos):
  hechosbien = ""
  for n in hechos:
    hechosbien = "Hecho" + str(n) + ": " + str(hechos[n]) + "\n"
  ejemplosbien = ""
  ...
  {}
  """.format(hechosbien,ejemplosbien)

  return prompt + "\n" + prompt2

def juego(historia_larga, historia_corta, hechos: list, ejemplos):
  messages = [
      "Eres un experto distinguiendo si un usuario a descubierto cosas de una historia. Vas a responder en JSON",dopropmt(historia_larga,historia_corta,hechos,ejemplos)
  ]
